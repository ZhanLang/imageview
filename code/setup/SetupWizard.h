...
#include "7z/SevenZip/SevenZipExtractor.h"
class CSetupWizard:
	public IMsPlugin,
	public IMsPluginRun,
	public ISetupWizard,
...
protected:
	...
	STDMETHOD_(LPCTSTR, GetTempCheckOutPath)();
...
public:
	BEGIN_DEFLUAFUNCTION_MAP("Setup",CLuaPluginImpl)
		...
		DEFINE_LUAFUNCTION_JSON_NO_IN_PARAM("GetTempCheckOutPath", LuaGetTempCheckOutPath)
...
private:
	...
	BOOL LuaGetTempCheckOutPath(Json::Value& outParam);
